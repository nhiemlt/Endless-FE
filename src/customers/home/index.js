...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const fetchTopSellingProducts = async () => {
      try {
        const data =
          await productVersionService.getTopSellingProductVersionsAllTime()
            ...
            <div className='flex flex-col lg:flex-row mx-auto md:space-x-6 lg:space-x-6 xl:space-x-6'>
              ...
              <div className='lg:w-1/2 flex flex-col text-center lg:text-left'>
                ...
                <p className='text-sm sm:text-base text-gray-900 dark:text-white mt-4'>
                  Chào mừng bạn đến với ENDLESS – điểm đến lý tưởng cho những
                  tín đồ yêu thích công nghệ! Tại ENDLESS, chúng tôi cung cấp
                  một loạt các sản phẩm điện tử chất lượng cao với mức giá hấp
                  dẫn, giúp bạn dễ dàng chọn lựa và sở hữu những thiết bị công
                  nghệ tiên tiến. Hãy khám phá các ưu đãi đặc biệt và trải
                  nghiệm dịch vụ giao hàng nhanh chóng, an toàn. Cảm ơn bạn đã
                  lựa chọn ENDLESS – nơi mua sắm không giới hạn!
                </p>
              ...
              <div className='lg:w-1/2 lg:justify-end mt-8 xs:mt-1 sm:mt-2 md:mt-3 lg:mt-0 p-2 flex items-center justify-center'>
                <TopSellingProducts />
              </div>
            </div>
          </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-4 p-3'>
              ...
              <div className='flex items-center space-x-3 dark:text-white text-gray-900'>
                ...
                <div>
                  ...
                  <br />
                  <small>Cho mọi đơn hàng trên $100</small>
                </div>
              </div>

              {/* Ưu Đãi Ngày Hằng Ngày */}
              <div className='flex items-center space-x-3 dark:text-white text-gray-900'>
                <div className='text-center text-5xl font-bold'>
                  <i className='fa-solid fa-gift'></i>
                </div>
                <div>
                  <b>Ưu Đãi Ngày Hằng Ngày</b>
                  <br />
                  <small>Giảm giá lên đến 25%</small>
                </div>
              </div>
              ...
              <div className='flex items-center space-x-3 dark:text-white text-gray-900'>
                ...
                <div>
                  <b>Hỗ Trợ 24/7</b>
                  <br />
                  <small>Mua sắm cùng chuyên gia</small>
                </div>
              </div>
              ...
              <div className='flex items-center space-x-3 dark:text-white text-gray-900'>
                ...
                <div>
                  <b>Giá Cả Hợp Lý</b>
                  <br />
                  <small>Mua với giá trực tiếp từ nhà máy</small>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className='max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16'>
              <div className='max-w-xl'>
                ...
                <p className='mt-4  text-black dark:text-white'>
                  Chúng tôi cung cấp sản phẩm chất lượng cao với mức giá hợp lý,
                  cam kết mang đến cho khách hàng trải nghiệm mua sắm tuyệt vời
                  nhất.
                </p>
              </div>
              ...
              <div className='mt-8 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 md:gap-12 lg:grid-cols-3'>
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='mt-1 text-sm text-black dark:text-white'>
                      Mỗi sản phẩm của chúng tôi đều được chọn lọc kỹ lưỡng, đảm
                      bảo chất lượng cao, đáp ứng nhu cầu của mọi khách hàng.
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='mt-1 text-sm text-black dark:text-white'>
                      Chúng tôi luôn đảm bảo cung cấp sản phẩm với mức giá cạnh
                      tranh, giúp bạn mua sắm tiết kiệm mà vẫn nhận được giá trị
                      xứng đáng.
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='mt-1 text-sm text-black dark:text-white'>
                      ...
                      24/7, giải đáp mọi thắc mắc và giúp bạn có trải nghiệm mua
                      sắm tốt nhất.
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='mt-1 text-sm text-black dark:text-white'>
                      Chúng tôi cam kết giao hàng nhanh chóng, đúng thời gian,
                      đảm bảo sản phẩm đến tay bạn trong thời gian ngắn nhất.
                    </p>
                  </div>
                </div>
                {/* Ưu đãi thường xuyên */}
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='mt-1 text-sm text-black dark:text-white'>
                      Chúng tôi cung cấp các chương trình giảm giá hấp dẫn dành
                      cho tất cả khách hàng. Tất cả đều có thể tham gia vào các
                      chương trình khuyến mãi với mức giảm giá đặc biệt!
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='mt-1 text-sm text-black dark:text-white'>
                      Những đánh giá tích cực từ khách hàng khi trải nghiệm sản
                      phẩm của chúng tôi, giúp những khách hàng có sự tin cậy
                      vào sản phẩm mà chúng tôi mang đến.
                    </p>
                  </div>
                </div>
              </div>
              ...
              {Array.isArray(products) && products.length > 0 ? (
                products.map(product => (
                  ...
                  >
                    <img
                      src={product.image}
                      className='w-auto h-32 object-cover transition duration-500 group-hover:scale-105 mx-auto'
